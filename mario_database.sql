...
ALTER TABLE ONLY public.sounds DROP CONSTRAINT sounds_character_id_fkey;
ALTER TABLE ONLY public.more_info DROP CONSTRAINT more_info_character_id_fkey;
ALTER TABLE ONLY public.character_actions DROP CONSTRAINT character_actions_character_id_fkey;
ALTER TABLE ONLY public.character_actions DROP CONSTRAINT character_actions_action_id_fkey;
ALTER TABLE ONLY public.sounds DROP CONSTRAINT sounds_pkey;
ALTER TABLE ONLY public.sounds DROP CONSTRAINT sounds_filename_key;
ALTER TABLE ONLY public.more_info DROP CONSTRAINT more_info_pkey;
ALTER TABLE ONLY public.more_info DROP CONSTRAINT more_info_character_id_key;
ALTER TABLE ONLY public.characters DROP CONSTRAINT characters_pkey;
ALTER TABLE ONLY public.character_actions DROP CONSTRAINT character_actions_pkey;
ALTER TABLE ONLY public.actions DROP CONSTRAINT actions_pkey;
ALTER TABLE ONLY public.actions DROP CONSTRAINT actions_action_key;
...
DROP TABLE public.character_actions;
